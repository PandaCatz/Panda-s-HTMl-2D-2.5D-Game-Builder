...
import { captureReplayState, LOOPLAB_REPLAY_COLLISION_HASH_VERSION, LOOPLAB_REPLAY_ACTOR_HASH_VERSION, LOOPLAB_REPLAY_ELEVATION_HASH_VERSION } from "../lib/looplab-replay.mjs";
