...
test("runtime hazard respawns expose exact failure and support coordinates to the observer", () => {
  ...
  assert.deepEqual(runtime.getState().player, { id: "player", x: 81, y: 404, z: 0, vx: 0, vy: 0, grounded: false, groundChainId: null, groundSegmentId: null, groundNormalX: 0, groundNormalY: -1, slopeSliding: false });
});
