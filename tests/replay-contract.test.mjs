...
test("production Doctor and the manifest expose executable replay truth", () => {
  ...
  assert.deepEqual(manifest.deterministicReplay.digestAlgorithms, { legacyVersions: [1, 2, 3, 4, 5], legacy: "FNV-1a-32", sha256Versions: [6, 7, 8, 9, 10, 11, 12, 13], currentVersion: LOOPLAB_REPLAY_HASH_VERSION, current: "SHA-256" });
