...
export function getAgentManifest() {
  ...
  return {
    ...
    exportedRuntime: {
      ...
      commands: ["get_source_digest", "get_runtime_adapter", "get_input_action_liveness", "get_completion_report", "get_narrative_contract", "get_narrative_report", "get_save_report", "get_save_status", "export_save_code", "inspect_save_code", "import_save_code", "persist_hosted_save", "clear_hosted_save", "get_state", "get_objects", "get_traversal_paths", "get_collision_geometry", "get_elevation_transitions", "get_tile_program", "get_tile_runtime", "get_world_stream_state", "mark_world_stream_draw", "get_motion_body_states", "get_actor_states", "get_combat_state", "get_navigation", "get_gameplay_state", "get_choice_state", "get_quest_state", "get_hud_state", "choose_choice", "get_runtime_join_plan", "begin_runtime_join_probe", "commit_runtime_join_probe", "finish_runtime_join_probe", "get_collision_box", "get_acceptance_tests", "run_acceptance_test", "run_acceptance_suite", "get_replay_cases", "run_replay_case", "run_replay_suite", "set_input", "step", "reset", "load_map", "pause", "resume"],
    },
