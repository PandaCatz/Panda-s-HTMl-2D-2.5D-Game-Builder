...
${embeddedStorageScript}${embeddedEngineScript}  <script>
    ...
    const presentation=createPresentationRuntime(project.presentationProgram,{host:globalThis,document:document,width:canvas.width,height:canvas.height,resources:project.resources||[],getPoint:presentationPoint});
