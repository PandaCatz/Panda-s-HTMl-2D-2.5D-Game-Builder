...
export const LOOPLAB_MCP_SERVER_VERSION = "1.2.0";
...
define(["set_runtime_profile"], schema({
  framework: enumeration(["canvas", "phaser"], "The single primary 2D runtime adapter. Phaser remains optional and is embedded only when selected."),
...
define(["compare_iterations"], schema({ ids: array(string("Iteration ID."), "Exactly two iteration IDs.", { minItems: 2, maxItems: 2 }) }, ["ids"]));
...
const SPECIAL_DESCRIPTIONS = Object.freeze({
  ...
  set_runtime_profile: "Atomically select one release-ready primary 2D runtime adapter and its exact offline delivery metadata. Canvas and the pinned Phaser browser adapter are currently available; knowledge-only adapters cannot be mislabeled as shipped support.",
