...
export function buildCandidateDecisionPacket({ first, second, changed, delta, doctor, counts, structuralDiff = null }) {
  ...
  return {
    ...
    digest: canonicalSha256({
      ...
      structuralDiffDigest: structuralDiff?.digest ?? null,
